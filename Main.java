...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            String uri = "Teste de URI";

            // Criação do cliente HTTP
            HttpClient client = HttpClient.newHttpClient();

            // Construção do corpo da requisição
            String jsonBody = "{ \"username\": \"12345\" }";
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .method("POST", BodyPublishers.ofString(jsonBody))
                    .build();
            ...
            System.out.println("Status Code Default: " + response.statusCode());
